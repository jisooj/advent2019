...
public class p2 {
   ...
   public static void main(String[] args) {
      ...
      LinkedList<char[][]> maps = new LinkedList<>();
      initMap(maps, in);
      for (int i = 0; i < 200; i++) {
         nextIter(maps);   
      }
      print(maps);
      System.out.println(getTotalBugs(maps));
   }

   public static void nextIter(LinkedList<char[][]> maps) {
   ...
   public static void print(List<char[][]> maps) {
      for (char[][] map : maps) {
         for (char[] line : map) {
   ...
   public static void initMap(List<char[][]> maps, Scanner in) {
      char[][] map = new char[R][];
      int i = 0;
   ...
   public static int getTotalBugs(List<char[][]> maps) {
      int count = 0;
      for (char[][] map : maps) {
